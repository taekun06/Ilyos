/* ILYOS — musique dédiée au Cabinet d'énigmes.
   ...
   Séquence simple : Intro.mp3 → 2.mp3 → 3.mp3 → 2.mp3 → 3.mp3…
   L'Intro ne rejoue pas lors d'un recommencement ou d'un retour à la liste des
   Sanctuaires. Les bruitages restent actifs. Si les MP3 ne sont pas encore
   présents, le système audio normal continue sans bloquer le mode Puzzle. */
